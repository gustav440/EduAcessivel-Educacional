...
export declare class Webhooks extends APIResource {
     ...
     * ```
     */
    list(query?: WebhookListParams | null | undefined, options?: RequestOptions): PagePromise<WebhookEndpointsPage, WebhookEndpoint>;
    /**
